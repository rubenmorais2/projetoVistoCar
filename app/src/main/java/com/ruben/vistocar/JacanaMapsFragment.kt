 ...
 * Use the [JacanaMapsFragment.newInstance] factory method to
 * create an instance of this fragment.
 */

class JacanaMapsFragment : Fragment(), OnMapReadyCallback {
    ...
    override fun onMapReady(googleMap: GoogleMap?) {
        ...
        var location = LatLng(-23.467821, -46.589279)
        var update = CameraUpdateFactory.newLatLngZoom(location, 18f)
        map?.moveCamera(update)
        
        map?.addMarker(MarkerOptions().title("Visto Car Unidade Jaçanã").position(location))

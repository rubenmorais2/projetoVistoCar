 ...
 * Use the [IpirangaMapsFragment.newInstance] factory method to
 * create an instance of this fragment.
 */

class IpirangaMapsFragment : Fragment(), OnMapReadyCallback {
    ...
    override fun onMapReady(googleMap: GoogleMap?) {
        ...
        var location = LatLng(-23.606836, -46.605223)
        var update = CameraUpdateFactory.newLatLngZoom(location, 18f)
        map?.moveCamera(update)

        map?.addMarker(MarkerOptions().title("Visto Car Unidade Ipiranga").position(location))
